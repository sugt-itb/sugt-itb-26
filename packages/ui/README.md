...
| `time-field`   | hand-written          | every time-of-day input — Session, online-Session, Perjadin session and logistics times — forced to 24-hour on any browser locale ([#328](https://github.com/mafiefa02/sugt/issues/328)); a masked text input because no attribute forces the native `<input type="time">` picker off the browser's AM/PM |
...
| `tooltip`, `dropdown-menu`, `pagination`, `scroll-area`, `navigation-menu` | No surface asks for one. The public header is four links; forty-seven Schools do not paginate.                                                                                                                                                                                                                                                                                                                        |
